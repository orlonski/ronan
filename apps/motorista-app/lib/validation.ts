...
/**
 * Formata issues já serializadas (vindas do backend em PendingViagem.errorIssues
 * ou no body de ApiError 400) em mensagem PT-BR multi-linha pro motorista.
 */
...
/**
 * Formata z.ZodError (validação local antes de enfileirar). Adapta o path
 * que vem como (string|number)[] pro formato achatado.
 */
